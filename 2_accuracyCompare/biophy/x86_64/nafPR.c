...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 2, "cvodeieq");
 	...
 	ivoc_help("help ?1 nafPR /home/yuz615/Bio/githubVersion/accuracyCompare/biophy/modfile/nafPR.mod\n");
...
{
 { error =  states();
 if(error){fprintf(stderr,"at line 78 in file nafPR.mod:\n  SOLVE states METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 } }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/yuz615/Bio/githubVersion/accuracyCompare/biophy/modfile/nafPR.mod";
static const char* nmodl_file_text = 
