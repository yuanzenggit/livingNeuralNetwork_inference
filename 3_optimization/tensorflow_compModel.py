...
# Parameters///////////////////////////////////////////////////////
preprocessingOn, estimatorOn, adlrOn, privatewOn, seed, sparsity = 1, 1, 0, 1, 0, 40
...
with tf.Session(config=tf.ConfigProto(allow_soft_placement=True,gpu_options = tf.GPUOptions(per_process_gpu_memory_fraction=0.05))) as sess:
		...
		for epoch in range(training_epochs):
				...
				for i in range(datalen_train):
						...
						_, _, c, p, t, s, b= sess.run([w1_new, w2_new, cost, pred, label, spike, layer1b],
						...
						if epoch==1:
							...
							#print(s)
							#printout.append(b.reshape(1,100))
							printout1=[]
							for j in range(100):
									if (b[j][0]):
											printout1.append(j)
